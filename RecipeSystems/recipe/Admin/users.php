<title>Recipick | Customer records</title>
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                 ...
                 <table id="example1" class="table table-bordered table-hover text-sm">
                  ...
                  <tbody id="users_data">
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM users_account JOIN diet ON users_account.select_meal_plan_history=diet.diet_Id WHERE role_as=0 AND deactivate=0 ORDER BY date_created ASC");
