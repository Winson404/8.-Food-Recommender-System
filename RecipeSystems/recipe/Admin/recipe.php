          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <div class="d-flex">
                  <a href="recipe_add.php" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle"></i> Add</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-sm text-sm">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $sql = mysqli_query($conn, "SELECT * FROM recipe JOIN diet ON recipe.recipe_diet_Id=diet.diet_Id");
